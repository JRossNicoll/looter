...
export default function TemplateRow({ template, onUseTemplate, onEditTemplate, onRenameTemplate, onDeleteTemplate }) {
  ...
  return (
    <div className="group">
      <div className="flex items-center justify-between rounded-lg px-2 py-2 text-sm hover:bg-zinc-900/50 transition-colors">
        <button
          onClick={handleUse}
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              className="opacity-0 group-hover:opacity-100 p-1 rounded hover:bg-zinc-800 transition-opacity"
            >
            ...
            <AnimatePresence>
              {showMenu && (
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-1 w-36 rounded-lg border border-zinc-800 bg-zinc-900 py-1 shadow-lg z-[100]"
                >
                  <button
                    onClick={handleUse}
                  ...
                  <button onClick={handleRename} className="w-full px-3 py-1.5 text-left text-xs hover:bg-zinc-800">
                    Rename
                  </button>
                  <button
                    onClick={handleDelete}
                    className="w-full px-3 py-1.5 text-left text-xs text-red-600 hover:bg-zinc-800 flex items-center gap-2"
                  >
