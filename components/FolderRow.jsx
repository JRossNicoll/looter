            ...
            <AnimatePresence>
              {showMenu && (
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-1 w-32 rounded-lg border border-zinc-800 bg-zinc-900 py-1 shadow-lg z-[100]"
                >
                  ...
                  <button
                    ...
                    className="w-full px-3 py-1.5 text-left text-xs text-red-600 hover:bg-zinc-800"
                  >
                    Delete
                  </button>
                </motion.div>
